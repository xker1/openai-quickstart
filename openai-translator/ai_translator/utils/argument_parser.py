...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--output_file_path', type=str, help='The path to save the translated book')
        self.parser.add_argument('--original_language', type=str, help='The language in which the document is written')
        self.parser.add_argument('--target_language', type=str, help='The language in which the document is transformed')
